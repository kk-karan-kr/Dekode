...
export function Globe({ globeConfig, data }) {
  ...
  // Initialize globe and initial rotation
  useEffect(() => {
    if (!globeRef.current && groupRef.current) {
      ...
      if (globeConfig.initialPosition) {
        ...
        // Three.js rotation: 
        // y handles longitude (negative because Earth rotates East to West relative to fixed camera)
        // x handles latitude
...
export function World(props) {
  ...
  return (
    <Canvas dpr={[1, 1.5]} scene={scene} camera={{ fov: 50, near: 180, far: 1800, position: [0, 0, cameraZ] }}>
      <WebGLRendererConfig />
